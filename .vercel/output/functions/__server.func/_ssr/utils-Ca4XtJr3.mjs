...
//#region node_modules/.nitro/vite/services/ssr/assets/utils-Ca4XtJr3.js
/**
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-DPolex5j.mjs");
...
//#endregion
export { parseStringArray as i, cn as n, initials as r, authMiddleware as t };
